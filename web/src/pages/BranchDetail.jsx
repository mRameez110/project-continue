...
const BranchDetail = () => {
  ...
  const handleEdit = async (branchId) => {
    try {
      ...
      // Prepare updated branch data by excluding system fields like __v, _id, createdAt, pharmacists
      ...
      const response = await axios.put(
        ...
        dataToUpdate, // Send only updated fields
        {
          headers: {
      ...
      navigate(`/admin/branches`); // After update, navigate to the list of branches
    } catch (error) {
  ...
  const handleDelete = async (branchId) => {
    ...
    try {
      ...
      showSuccessToast(response.data.message);
      navigate(`/admin/branches`); // After delete navigate to the list of branches
    } catch (error) {
  ...
  // Helper function to display a default value if something is missing
    ...
    <div className="p-4 sm:p-6 max-w-4xl mx-auto">
      ...
      <div className="border p-4 sm:p-6 rounded-lg shadow-lg bg-white">
        <div className="mb-4">
          ...
          <p className="text-gray-600">
            <strong>Contact Info:</strong> {displayValue(branch.contactInfo)}
          </p>
        </div>

        {/* Pharmacists List - Displayed but not editable */}
        ...
        {/* Edit Section for Branch - Only Branch Fields Are Editable */}
        {isEditing && (
          <div className="mt-4">
        ...
        {/* Buttons for Editing, Saving, and Deleting */}
        {canEditOrDelete && (
