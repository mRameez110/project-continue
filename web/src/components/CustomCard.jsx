...
const CustomCard = ({ pharmacist }) => {
	return (
		<div className="max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl mx-auto p-4 bg-white border  break-all border-gray-200 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-400 ease-in-out transform hover:scale-105">
